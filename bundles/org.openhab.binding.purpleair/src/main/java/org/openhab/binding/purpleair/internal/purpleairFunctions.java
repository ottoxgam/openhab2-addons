...
public class purpleairFunctions {
    public String aqiFromPM(int pm) {
    ...
    public void bplFromPM(int pm) {
    if (isNaN(int pm)) return 0;
    if (pm == undefined) {
        return 0;
    }
    if (pm < 0) {
    ...
    public void calcAQI(Cp, Ih, Il, BPh, BPl) {
    ...
    public void getAQIMessage(string) {
      if (aqi >= 401) {
